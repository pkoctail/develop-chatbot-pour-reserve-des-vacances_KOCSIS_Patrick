...
class MainDialog(ComponentDialog):
    ...
    async def final_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        if step_context.result is not None:
            ...
            msg_txt = f"I have you booked to {result.dst_city} from {result.or_city} departing on {result.str_date} returning on {result.end_date} for a budget of {result.budget}"
